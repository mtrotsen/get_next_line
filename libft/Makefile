...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/11/07 12:12:41 by mtrotsen          #+#    #+#              #
#    Updated: 2018/11/22 12:07:53 by mtrotsen         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
ft_lstnew.c ft_is_negative.c ft_iterative_factorial.c ft_swap.c \
ft_recursive_factorial.c ft_sqrt.c ft_lstadd.c ft_lstdel.c \
...
ft_lstnew.o ft_is_negative.o ft_iterative_factorial.o ft_swap.o \
ft_recursive_factorial.o ft_sqrt.o ft_lstadd.o ft_lstdel.o \
